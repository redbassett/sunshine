...
public class TestDb extends AndroidTestCase {
    ...
    */
    public void testLocationTable() {
        ...
        assertFalse("Errror: More than one record returned from location query", cursor.moveToNext());
    ...
    public void testWeatherTable() {
        ...
        // Move the cursor to a valid database row
        assertTrue("ErrorL No Records returned from weather query", cursor.moveToFirst());
        ...
        assertFalse("Error: More than one record returned from location weury", cursor.moveToNext());
